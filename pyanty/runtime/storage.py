...
def collect_garbage(api: object = None, profile_id: int | str | None = None) -> None:
...
def scan_api_token() -> str:
    if sys.platform == "win32":
        ...
        storage_path = os.path.expanduser(
            "~/Library/Application Support/dolphin_anty/Local Storage/leveldb"
        )
    else:
        storage_path = os.path.expanduser(
            "~/.config/dolphin_anty/Local Storage/leveldb"
        )
    ...
    try:
        ...
        from ..vendor.ccl_leveldb import RawLevelDb
        ...
        raise ValueError(
            "CCL LevelDB library not available. Please ensure ccl_leveldb "
